...
echo "============================================================="
echo "BNB Chain Worker - Ankr API Configuration"
echo "============================================================="
...
echo "Building BNB Chain worker..."
go build -o bnb_worker ./cmd/run_evm_worker
...
# Run the worker
echo "Starting BNB Chain worker..."
# ./bnb_worker
./bnb_worker --chain bnb --log-level debug
