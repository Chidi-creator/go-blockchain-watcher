...
export EVM_CHAIN="matic"

# Display information about API configuration
echo "============================================================="
echo "Polygon (MATIC) Worker - Ankr API Configuration"
echo "============================================================="
...
echo "Building Polygon worker..."
go build -o matic_worker ./cmd/run_evm_worker
...
# Run the worker
echo "Starting Polygon worker..."
# ./matic_worker
./matic_worker --chain matic --log-level debug
