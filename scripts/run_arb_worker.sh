...
export EVM_CHAIN="arb"

# Display information about API configuration
echo "============================================================="
echo "Arbitrum Worker - Ankr API Configuration"
echo "============================================================="
...
echo "Building Arbitrum worker..."
go build -o arb_worker ./cmd/run_evm_worker
...
# Run the worker
echo "Starting Arbitrum worker..."
# ./arb_worker
./arb_worker --chain arb --log-level debug
