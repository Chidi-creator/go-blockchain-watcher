...
export EVM_CHAIN="dai"

# Display information about API configuration
echo "============================================================="
echo "Gnosis (xDAI) Worker - Ankr API Configuration"
echo "============================================================="
...
echo "Building Gnosis worker..."
go build -o dai_worker ./cmd/run_evm_worker
...
# Run the worker
echo "Starting Gnosis worker..."
# ./dai_worker
./dai_worker --chain dai --log-level debug
